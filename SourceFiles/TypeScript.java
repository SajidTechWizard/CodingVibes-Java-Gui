...
public class TypeScript extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/TypeScript.png");
	
	
	public TypeScript()
	{
		super("TypeScript Course");
		...
		{
			JOptionPane.showMessageDialog(this, "TypeScript has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("TypeScript", "3.5 weeks", "3500 Taka");
