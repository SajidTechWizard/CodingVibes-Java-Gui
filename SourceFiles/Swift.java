...
public class Swift extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/Swift.png");
	...
	public Swift()
	{
		...
		{
			JOptionPane.showMessageDialog(this, "Swift has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("Swift", "4 weeks", "4700 Taka");
