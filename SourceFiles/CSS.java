...
public class CSS extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/CSS.png");
	...
	public CSS()
	{
	  ...
	  public void actionPerformed(ActionEvent ae) {
		...
		{
			JOptionPane.showMessageDialog(this, "CSS has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("CSS", "8 weeks", "4500 Taka");
