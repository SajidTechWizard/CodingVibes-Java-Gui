...
public class Matlab extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/Matlab.png");
	...
	public Matlab()
	{
		...
		{
			JOptionPane.showMessageDialog(this, "MATLAB has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("MATLAB", "5 weeks", "4900 Taka");
