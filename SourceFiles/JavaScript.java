...
public class JavaScript extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/JavaScript.png");
	
	
	public JavaScript()
	{
		super("JavaScript Course");
	  ...
	  public void actionPerformed(ActionEvent ae) {
		...
		{
			JOptionPane.showMessageDialog(this, "JavaScript has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("JavaScript", "7 weeks", "5000 Taka");
