...
public class Scala extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/Scala.png");
	...
	public Scala()
	{
		...
		{
			JOptionPane.showMessageDialog(this, "Scala has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("Scala", "6 weeks", "4800 Taka");
