...
public class Python extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/Python.png");
	...
	public Python()
	{
	  ...
	  public void actionPerformed(ActionEvent ae) {
		...
		{
			JOptionPane.showMessageDialog(this, "Python has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("Python", "7 weeks", "7000 Taka");
