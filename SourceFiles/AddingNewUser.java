...
public class AddingNewUser extends JFrame implements ActionListener , AddUserInterface {
	...
	ImageIcon icon = new ImageIcon ("Photos/AddingNewUser.png");
	...
	public AddingNewUser ()
	{
		...
		AddUser.setBounds(890,520,120,40);
		...
		showpassBox.setBounds(760,308,125,15);
    ...
    try {
        ...
        bufferWriter.close();
        JOptionPane.showMessageDialog(p1, "This User has been Added!", "CodingVibes", JOptionPane.INFORMATION_MESSAGE);
		
	    AddingNewUser.this.setVisible(false);
        new AdminDashboard();
