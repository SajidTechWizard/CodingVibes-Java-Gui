...
public class PHP extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/PHP.png");
	...
	public PHP()
	{
	   ...
	   cart = new JButton("Add to Cart");
		...
		{
			JOptionPane.showMessageDialog(this, "PHP has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("PHP", "4 weeks", "2500 Taka");
