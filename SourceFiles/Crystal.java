...
public class Crystal extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/Crystal.png");
	
	
	public Crystal()
	{
		super("Crystal Course");
		...
		{
			JOptionPane.showMessageDialog(this, "Crystal has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("Crystal", "6 weeks", "5200 Taka");
