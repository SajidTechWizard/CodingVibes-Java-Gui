...
public class MySQL extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/MySQL.png");
	...
	public MySQL()
	{
	  ...
	  public void actionPerformed(ActionEvent ae) {
		...
		{
			JOptionPane.showMessageDialog(this, "MySQL has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("MySQL", "4 weeks", "5200 Taka");
