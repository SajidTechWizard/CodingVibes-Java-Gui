...
public class Kotlin extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/Kotlin.png");
	...
	public Kotlin()
	{
	   ...
	   cart = new JButton("Add to Cart");
		...
		{
			JOptionPane.showMessageDialog(this, "Kotlin has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("Kotlin", "4.5 weeks", "5500 Taka");
