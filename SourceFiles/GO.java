...
public class GO extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("CourseImages/GO.png");
	...
	public GO()
	{
	  ...
	  public void actionPerformed(ActionEvent ae) {
		...
		{
			JOptionPane.showMessageDialog(this, "Golang has been added to your cart","CodingVibes",-1);
			
			this.setVisible(false);
			CartPage cartPage = new CartPage();
			cartPage.addToCart("Golang", "9 weeks", "6000 Taka");
